  ...
  create or replace table `bachelor-thesis-344103`.`optimized_data_warehouse`.`assign_all_visit_ids`
...
FROM `bachelor-thesis-344103`.`raw_data_warehouse`.`encounters` e
JOIN `bachelor-thesis-344103`.`optimized_data_warehouse`.`all_visits` AV
